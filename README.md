...
running command...
$ xcl (--version)
xcl/1.0.2-beta.1 win32-x64 node-v16.16.0
$ xcl --help [COMMAND]
USAGE
  $ xcl COMMAND
...
...
_See code: [build/commands/config/index.ts](https://github.com/MaikMichel/xcl/blob/v1.0.2-beta.1/build/commands/config/index.ts)_
...
_See code: [build/commands/feature/index.ts](https://github.com/MaikMichel/xcl/blob/v1.0.2-beta.1/build/commands/feature/index.ts)_
...
FLAGS
  -c, --connection=<value>  [default: 116.1.1.21:1521/WILMA] connection string HOST:PORT/SERVICE_NAME
  -h, --help                Show CLI help.
...
FLAGS
  -c, --connection=<value>  [default: 116.1.1.21:1521/WILMA] connection to database (required when deinstall Feature) [
...
FLAGS
  -c, --connection=<value>  (required) [default: 116.1.1.21:1521/WILMA] connection string HOST:PORT/SERVICE_NAME
...
_See code: [build/commands/project/index.ts](https://github.com/MaikMichel/xcl/blob/v1.0.2-beta.1/build/commands/project/index.ts)_
...
FLAGS
  -c, --connection=<value>  [default: 116.1.1.21:1521/WILMA] Connectstring ex. localhost:1521/xepdb1
